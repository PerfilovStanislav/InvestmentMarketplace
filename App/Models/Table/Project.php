...
class Project extends AbstractEntity implements ModelInterface {
    ...
    protected static array
        $properties = [
            ...
            'plan_percents'      => [self::TYPE_FLOAT_ARRAY, [Validator::MIN  => 0.01, Validator::MAX  => 99999.99]],
            ...
            'min_deposit'        => [self::TYPE_FLOAT,       [Validator::MIN  => 0.000001, Validator::MAX  => 999999.999999]],
