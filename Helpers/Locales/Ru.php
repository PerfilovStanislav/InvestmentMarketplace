...
class Ru extends AbstractLanguage {
    public string
        ...
        $emailConfirmSent  = 'Код подтверждения отправлен вам на почту',
        $emailIsBusy       = 'Данный email уже зарегистрирован. Введите другой',
        $enter             = 'Войти',
        $error             = 'Ошибка',
        $exit              = 'Выйти',
        $free              = 'бесплатно',
        ...
        $noConfirmCode     = 'Не найден код подтверждения',
        ...
        $options           = 'Опции',
        $or                = 'или',
        $orCopyLink        = 'Или скопируйте эту ссылку в ваш браузер',
        $password          = 'Пароль',
        ...
        $verifyAccount     = 'Подтвердить мой аккаунт',
        $view              = 'Просмотр',
