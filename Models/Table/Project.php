    ...
    class Project extends AbstractEntity implements EntityInterface {
        ...
        protected static
            ...
            $properties = [
                ...
                'paymenttype'        => [self::TYPE_INT,    [Validator::MIN  => 1]],
                'ref_percent'        => [self::TYPE_ARRAY,  [Validator::MIN  => 1]],
                'plan_percents'      => [self::TYPE_ARRAY,  [Validator::MIN  => 1]],
                'plan_period'        => [self::TYPE_ARRAY,  [Validator::MIN  => 1]],
                'plan_period_type'   => [self::TYPE_ARRAY,  [Validator::MIN  => 1]],
                'plan_start_deposit' => [self::TYPE_ARRAY,  [Validator::MIN  => 1]],
                'plan_currency_type' => [self::TYPE_ARRAY,  [Validator::MIN  => 1]],
                'id_payments'        => [self::TYPE_ARRAY,  [Validator::MIN  => 1]],
