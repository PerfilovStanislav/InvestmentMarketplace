  ...
  <div class="section">
    <div class="section row br-a br-greyer mn mb15 p2">
      <div class="col-md-6 img-container pl1 mb1">
          <img id="full_site_image" src="/assets/img/screenshot.png" alt="<?=$this->locale['screenshot']?>">
		  <input type="hidden" name="screen_data">
      </div>

      <div class="col-md-6 img-container pr1 mb1">
          <img id="thumb_site_image" src="/assets/img/screenshot.png" alt="<?=$this->locale['screenshot']?>">
