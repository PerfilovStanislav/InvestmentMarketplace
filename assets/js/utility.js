...
(function($) {
   ...
   function setAnimationCSS($this, $el) {
      ...
      $el.css({
         "transition": aniSpeed + "s right, " + aniSpeed + "s left, " + aniSpeed + "s top, " + aniSpeed + "s bottom, " + aniSpeed + "s height, " + aniSpeed + "s width"
      });
      return true;
   }
      ...
      var methods = {
         ...
         controlHandlers: function(e) {
            ...
            var panelFullscreen = function() {
				var scrl = panel.find('.scroller');
               if ($('body.panel-fullscreen-active').length) {
				  $(scrl).css('max-height', (50)+'px');
